...
# Deploy ArgoCD applications for QA environment

echo "🚀 Deploying ArgoCD applications for QA environment..."
...
# Create kaia-dex-qa namespace if it doesn't exist
echo "📦 Creating kaia-dex-qa namespace..."
kubectl create namespace kaia-dex-qa --dry-run=client -o yaml | kubectl apply -f -
...
kubectl apply -f qa-kaia-orderbook-dex-backend.yaml
kubectl apply -f qa-kaia-orderbook-dex-frontend.yaml
kubectl apply -f qa-kaia-orderbook-dex-core.yaml
...
echo "  argocd app sync qa-kaia-orderbook-dex-backend"
echo "  argocd app sync qa-kaia-orderbook-dex-frontend"
echo "  argocd app sync qa-kaia-orderbook-dex-core"
echo ""
